...
export const schemaDriftEvents: SchemaDriftEvent[] = [
  {
    ...
    changeObservedAt: "2026-06-09T10:07:00Z",
    detectionSlaMinutes: 15,
    detectionLatencyMinutes: 4,
    detectionSlaStatus: "within_sla",
  ...
  },
  {
    ...
    changeObservedAt: "2026-06-09T10:25:00Z",
    detectionSlaMinutes: 15,
    detectionLatencyMinutes: 8,
    detectionSlaStatus: "within_sla",
  ...
  },
  {
    ...
    changeObservedAt: "2026-06-09T09:40:00Z",
    detectionSlaMinutes: 30,
    detectionLatencyMinutes: 12,
    detectionSlaStatus: "within_sla",
  ...
  },
  {
    ...
    changeObservedAt: "2026-06-10T07:32:00Z",
    detectionSlaMinutes: 15,
    detectionLatencyMinutes: 33,
    detectionSlaStatus: "breached",
  ...
  },
  {
    ...
    changeObservedAt: "2026-06-01T08:42:00Z",
    detectionSlaMinutes: 15,
    detectionLatencyMinutes: 18,
    detectionSlaStatus: "breached",
    downstreamPipelineIds: ["p-8"],
...
export const pipelineRecoveryValidations: PipelineRecoveryValidation[] = [
  {
    ...
    recordsExpected: 1840000,
    recordsCompared: 460000,
    validationFailedRecords: 126,
    validationPendingRecords: 1380000,
    validationSuspendedRecords: 0,
    validationExceptionStatus: "pending_triage",
    quarantineLocation: "s3://recovery-quarantine/customer-360/2026-06-09/",
    exceptionRemediationPlan:
      "Keep invalid account snapshots isolated, repair the account_tier contract, then revalidate every pending and failed record before any controlled resync.",
    ...
    allowedLatenessMinutes: 60,
    lateRecordsDetected: null,
    eventTimeWatermarkVerified: false,
    lateArrivalEvidence:
      "The event-time scan is pending; operators cannot yet prove that delayed account snapshots stayed within the approved 60-minute lateness window.",
  ...
  },
  {
    ...
    recordsExpected: 842190,
    recordsCompared: 842190,
    validationFailedRecords: 27,
    validationPendingRecords: 0,
    validationSuspendedRecords: 184,
    validationExceptionStatus: "quarantined",
    quarantineLocation: "s3://recovery-quarantine/revenue-aggregate/2026-06-09/",
    exceptionRemediationPlan:
      "Retain duplicate keys and late revenue events in quarantine, correct merge ordering, and require clean revalidation evidence before resyncing finance data.",
    ...
    allowedLatenessMinutes: 30,
    lateRecordsDetected: 184,
    eventTimeWatermarkVerified: false,
    lateArrivalEvidence:
      "Event-time reconciliation found 184 revenue events beyond the 30-minute allowance, so the finance window remains incomplete despite a current sink watermark.",
  ...
  },
  {
    ...
    recordsExpected: 1295400,
    recordsCompared: 1295400,
    validationFailedRecords: 0,
    validationPendingRecords: 0,
    validationSuspendedRecords: 0,
    validationExceptionStatus: "cleared",
    quarantineLocation: null,
    exceptionRemediationPlan:
      "No exception records remain; the completed source-to-target comparison requires no quarantine resync before publication.",
    ...
    qualityChecksRequired: 3,
    downstreamWatermarkVerified: true,
    allowedLatenessMinutes: 10,
    lateRecordsDetected: 0,
    eventTimeWatermarkVerified: true,
    lateArrivalEvidence:
      "The replay advanced the event-time watermark past the window plus its 10-minute allowance with zero late clickstream events left unresolved.",
